...
const ReviewCreateConfirmDialog = ({commentaryId, onClose, onConfirm, onCancel, open}: {
    commentaryId?: string;
    open: boolean;
    onClose?: () => void;
    onConfirm?: () => void;
    ...
    return (
        <ConfirmDialog
            open={open}
            title={'Авторизация'}
            text={'Для написания отзыва, пожалуйста авторизуйтесь'}
...
export default ReviewCreateConfirmDialog;
