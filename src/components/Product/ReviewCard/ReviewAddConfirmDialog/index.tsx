...
const ReviewAddConfirmDialog = ({commentaryId, onClose, onConfirm, onCancel, open}: {
    commentaryId?: string;
    open: boolean;
    onClose?: () => void;
    onConfirm?: () => void;
    ...
    return (
        <ConfirmDialog
            open={open}
            title={'Авторизация'}
            text={'Для написания комментария, пожалуйста авторизуйтесь'}
...
export default ReviewAddConfirmDialog;
